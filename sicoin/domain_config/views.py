...
class DomainConfigAPIView(APIView):
    ...
    @swagger_auto_schema(operation_description="Creation of domain config. Only Admin can use this endpoint",
                         request_body=DomainSerializer,
                         responses={200: 'Domain successfully created', 400: 'Domain already created'})
